...
studentsNum_submit = Button(
    root, text="Submit", command=_createStudents).grid(row=4, column=2)
...
# Simulate button
Label(root, text="").grid(row=4, column=1)
simulate = Button(root, text="Simulate",
                  command=_simulate).grid(row=13, column=2)
...
assignment_submit = Button(
    root, text="Submit", command=_createAssignment).grid(row=10, column=2)
root.mainloop()
